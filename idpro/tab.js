(function (c, e, l, j) {
    ...
    i.PIXEL_RATIO = f;
    i = ["ms", "moz", "webkit", "o"];
    for (f = 0; f < i.length && !e.requestAnimationFrame; f++)
        (e.requestAnimationFrame = e[i[f] + "RequestAnimationFrame"]),
            (e.cancelAnimationFrame =
                e[i[f] + "CancelAnimationFrame"] ||
                e[i[f] + "CancelRequestAnimationFrame"]);
    ...
    q.prototype = {
        ...
        start: function () {
            ...
            this.animationHandle = e.requestAnimationFrame(function () {
                a.options.onLoop.apply(a.options.owner, [a._getThreadInfo()]) &&
                    a._loop();
            });
        },
        ...
        _kill: function () {
            ...
            c.isFunction(this.options.afterStop) &&
                this.options.afterStop.call(this.options.owner);
            c.isFunction(this.options.afterStopRequest) &&
    ...
    d.prototype = {
        ...
        init: function (a, b) {
            ...
            if ((this.canvases = this._build()))
                this._drawBackside(this.canvases.back),
                    ...
                    this._updateVal(0),
                    this.animate(this.options.initialValue, !1);
            return this;
        },
        ...
        _createCanvas: function (a, b) {
            if (0 === a || 0 === b)
                return console.log("Invalid canvas dimensions"), !1;
            ...
            if (!g.getContext)
                if ("undefined" !== typeof G_vmlCanvasManager)
                    ...
                    return (
                        console.log(
                            "Your browser does not support HTML5 Canvas, or excanvas is missing on IE"
                        ),
                        !1
                    );
            return g;
        ...
        _attachLabels: function () {
            var a = c("<span></span>").addClass(this.options.digitClassName),
                b = c("<span></span>")
                    .addClass(this.options.labelClassName)
                    .text(this.options.label),
                z = c("<span></span>")
                    .addClass(this.options.titleClassName)
                    .text(this.options.title),
                y = c("<span></span>")
                    .addClass(this.options.datesClassName)
                    .text(this.options.dates);
        ...
        _build: function () {
            for (
                var a = {}, b, g = 2 * this.attributes.radius.back, m = 0;
                m < d.CANVAS_NAMES.length;
                ++m
            ) {
            ...
            this.element.addClass(this.options.wrapperClassName).append(
                c.map(a, function (a) {
                    return a;
                })
            );
        ...
        _updateVal: function (a, b, d) {
            c.isNumeric(a) && c.isNumeric(b) && c.isNumeric(d)
                ? ((d = (d - b) * a),
                    (a = Math.max(
                        0,
                        Math.min(b + (100 * d) / this.options.maxValue, 100)
                    )),
                    (b = Math.max(0, Math.min(b + d, this.options.maxValue))))
                : ((a = Math.min(
                    this.attributes.currentValue / this.options.maxValue,
                    100
                )),
                    (b = Math.min(this.attributes.currentValue, this.options.maxValue)));
            this.labels.digit[0].innerHTML = (c.isFunction(this.options.format)
                ? this.options.format
                : function (a, b, c) {
                    return this.options.percent
                        ? a.toFixed(this.options.decimals) + "%"
                        : b.toFixed(this.options.decimals) +
                        "/" +
                        c.toFixed(this.options.decimals);
                }
        ...
        _redraw: function () {
            var a = this.canvases.fill,
                ...
                e =
                    2 * (this.attributes.currentValue / this.options.maxValue) * Math.PI;
            b.fillStyle = this.options.fillColor;
            b.clearRect(0, 0, a.width, a.height);
            0 !== e &&
                (b.save(),
                    1 < d.PIXEL_RATIO && b.scale(d.PIXEL_RATIO, d.PIXEL_RATIO),
                    b.translate(c, c),
                    b.rotate(-Math.PI / 2),
                    b.beginPath(),
                    b.arc(0, 0, f, 0, e, !1),
        ...
        animate: function (a, b) {
            function f(b) {
                1 === b.loops &&
                    ((j = new Date().getTime()),
                        (r = 2 * (a / this.options.maxValue) * Math.PI),
                        (p =
                            2 *
                            (this.attributes.currentValue / this.options.maxValue) *
                            Math.PI));
                ...
                0 !== e &&
                    (h.save(),
                        1 < d.PIXEL_RATIO && h.scale(d.PIXEL_RATIO, d.PIXEL_RATIO),
                        h.translate(i, i),
                        h.rotate(-Math.PI / 2),
                        h.beginPath(),
                        h.arc(0, 0, l, 0, e, !1),
                ...
                return b.stopRequested || 1 <= c
                    ? ((k.attributes.currentValue += (a - k.attributes.currentValue) * c),
                        !1)
                    : !0;
            }
            function e(a) {
                c(this).queue("circular", function (a) {
                    (this.activeAnimationThread = new q({
                        ...
                        afterStop: function () {
                            a();
                            0 === c(this).queue("circular").length &&
                                (this.activeAnimationThread = null);
                        },
                        owner: this
                    })).start();
            ...
            if (c.isNumeric(a) && !(0 > a || a > this.options.maxValue)) {
                ...
                !b && this.activeAnimationThread
                    ? (c(this).clearQueue("circular"),
                ...
                switch (a) {
                    ...
                    case "maxValue":
                        this.options.percent ||
                            ((this.attributes.currentValue = Math.max(
                                Math.min(this.attributes.currentValue, b),
                                0
                            )),
                                (this.options[a] = b),
                                this._redraw());
                    ...
                    case "percent":
                        b &&
                            ((this.options.maxValue = 100),
                                (this.attributes.currentValue = Math.max(
                                    Math.min(this.attributes.currentValue, 100),
                                    0
                                )));
                    case "format":
                    case "decimals":
    ...
    c.fn.CircularStat = function (a) {
        ...
        b
            ...
            : this.each(function () {
                c.data(this, "circular-stat") ||
                    c.data(this, "circular-stat", new d(this, a));
            });
        return f;
    };
    c(function () {
